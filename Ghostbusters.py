...
print("Your first mission as a New Ghostbuster is to find....\n  The ghost in the hotel... \n Enjoy, Don't Die "
      "Recruit !")
name = str(input("What is your name, Recruit ? "))

lobby = str(input("You reach the lobby of the hotel... \n You can either take the right or left stairs.... \n "
              "Type 'right' or 'left' to choose which direction to go "))

if lobby == "left" or lobby == "Left":
    ...
    if elevator == "climb" or elevator == "Climb ":
        Door = input("You reach the ninth floor, there are ghost noises everywhere but only three doors \n"
